...
- `delimiter` (String) Default delimiter (default: -). Falls back to LABEL_DELIMITER env var.
- `environment` (String) Environment identifier (e.g. ane2). Falls back to LABEL_ENVIRONMENT env var.
